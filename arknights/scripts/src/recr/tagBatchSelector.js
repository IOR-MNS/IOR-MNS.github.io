...
const batchSelectEventHandler = function (e) {
...
const banRecommendation = function (elem, featureID) {
...
const createRecommendationPanel = function (featureID, userConfigPath, title, description) {
...
const tagBatchSelectorGuide = function () {
...
$('#tagBatchSelector').keyup(function (ev) {
