...
const selectConfig = function () {
	// 설정에 따라 체크 상태 변경
	if (displayName) {
		$('#config-modal #display_name').prop('checked', true)
	}
	else {
		$('#config-modal #display_name').prop('checked', false)
	}
	
	if (displayInputField) {
		$('#config-modal #display_inputField').prop('checked', true)
	}
	else {
		$('#config-modal #display_inputField').prop('checked', false)
	}
...
const fetchConfig = function () {
	displayName = JSON.parse($('#config-modal #display_name').prop('checked'))
	displayInputField = JSON.parse($('#config-modal #display_inputField').prop('checked'))
