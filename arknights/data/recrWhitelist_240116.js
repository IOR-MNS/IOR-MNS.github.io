...
// 정해진 시각에 DB 자동 업데이트하도록 하는 코드
// 한, 일, 글섭 1/14 16시부터 공개모집 풀 추가. 한, 일섭은 UTC+9 기준, 글섭은 UTC-7 기준.
var updateData = recrWhiteList.kr
var updateTime = {
    kr: new Date(Date.UTC(2024, 0, 16, 7)), // month is 0-indexed
    us: new Date(Date.UTC(2024, 0, 16, 23))
}
var updateVersion = "2024.01.16"
var updateTimeStr = {}
