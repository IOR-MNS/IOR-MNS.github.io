...
// 마지막 확인: 2024-04-30 16:00
// 한, 일, 글섭
recrWhiteList.version.en = recrWhiteList.version.jp = recrWhiteList.version.kr = "2024.01.16"
...
// 정해진 시각에 DB 자동 업데이트하도록 하는 코드
// 한, 일, 글섭 4/30 16시부터 공개모집 풀 추가. 한, 일섭은 UTC+9 기준, 글섭은 UTC-7 기준.
var updateData = ["A41","A42","A43","A44","AA01","AA02","AA03","AZ01","BS02","BS03","BS04","FO01","FO02","FO03","GG01","GG03","HK01","IU04","IU05","JC01","JC03","JC05","JC06","KZ03","KZ04","LM04","LM05","LM08","LM10","LM11","LM12","LN01","LT01","LT05","LT77","MN02","MN03","PA11","PA12","PA13","PA14","PA15","PA41","PA42","PA43","PA44","PA61","PA62","PA63","PA64","PA65","PL02","PL03","PL04","R100","R104","R105","R106","R107","R108","R119","R122","R123","R128","R303","RB02","RCX2","RCX3","RCX4","RL01","RL02","RL03","RL04","RL05","RL06","RR01","SG01","SI01","SR03","SS02","ST01","ST02","ST03","SW01","SW02","US10","USS1","USS2","USS3","VC01","VC02","VC03","VC04","YD01","RE41","R110","HT03","SR27","LT02","LM20","LM19","KZ15","R155","YD05","R160","RV02","R158","HK03","R109","R148","R144","R117","R131","R129","RB05","USS4","RB03","R157","R172","RB04","R140","RCX5","LM14","II04","SR26","R147","II01","SG03","SG06","R139"]
var updateTime = {
    kr: new Date(Date.UTC(2024, 3, 30, 7)), // month is 0-indexed
    us: new Date(Date.UTC(2024, 3, 30, 23))
}
var updateVersion = "2024.04.30"
var updateTimeStr = {}
...
// 아직 업데이트가 완료되지 않았거나, 글로벌 버전 업데이트 이후 4일(96시간)이 지나지 않았다면
// 공개모집 풀 갱신 안내를 표시
if (!updateDone || Date.now() <= (updateTime.us.getTime() + 96*60*60*1000)) {
    document.querySelector('.announce-panel').style.display = 'block'
}
