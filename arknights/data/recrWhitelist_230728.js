...
// 마지막 확인: 2023-07-28 16:00
// 한, 일, 글섭
recrWhiteList.version.en = recrWhiteList.version.jp = recrWhiteList.version.kr = "2023.07.28"
...
var updateTime = {
    kr: new Date(Date.UTC(2023, 6, 28, 7)), // month is 0-indexed
    us: new Date(Date.UTC(2023, 6, 28, 23))
}
var updateVersion = "2023.07.28"
var updateTimeStr = {}
...
// 아직 업데이트가 완료되지 않았거나, 글로벌 버전 업데이트 이후 72시간이 지나지 않았다면
// 공개모집 풀 갱신 안내를 표시
if (!updateDone || Date.now() <= (updateTime.us.getTime() + 72*60*60*1000)) {
    document.querySelector('.announce-panel').style.display = 'block'
}
