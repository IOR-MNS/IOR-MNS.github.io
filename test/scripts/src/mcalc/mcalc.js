...
var itemOrder = {
	...
	"특수재료": [
		...
		["RMA70-24", "망간 중합체", "화이트 호스 콜",	"고급 연마석",	"중합젤",	"열합금 팩", "결정 회로", "정제된 용제", "절삭유 원액"],
		["RMA70-12", "망간 광석", "로식 콜", "연마석", "젤", "열합금", "결정 부품", "반합성 용제", "중합 절삭유"]
	],
	...
	for (var i = 0; i < itemOrder.keys.length; ++i) {
		...
		for (var j = 0; j < items.length; ++j) {
			for (var k = 0; k < items[j].length; ++k) {
                ...
                html += '" id="calc-item_' + items[j][k] + '"><div class="item_thumb"><img src="./images/item/inv_2/'
